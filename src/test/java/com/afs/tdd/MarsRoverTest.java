...
class MarsRoverTest {
    ...
    @Test
    void should_change_to_location_0_0_S_when_executeCommand_give_0_0_East_and_command_TurnRight() {
        //Given
        Location initialLocation = new Location(0, 0, Direction.EAST);
        MarsRover marsRover = new MarsRover(initialLocation);
        // When
    ...
    @Test
    void should_change_to_location_0_0_N_when_executeCommand_give_0_0_West_and_command_TurnRight() {
        //Given
        Location initialLocation = new Location(0, 0, Direction.WEST);
        MarsRover marsRover = new MarsRover(initialLocation);
        // When
